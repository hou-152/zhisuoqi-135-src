...
- 作者：宝玉
- 摘要：AI 原生开发没有抛弃传统流程，而是让人负责关键判断、让 Agent 执行分析、设计、编码与验证；本文用 BaoCut 远程转录功能完整复盘这套工作方式。
- 抓取：直抓原文（Reader 快照仅 79 字，正文为 JS 渲染未同步）（2026-09-12）
- 字数：6681

---

我的 AI 原生开发流程：一个真实案例的完整复盘 | 宝玉的分享
See all posts
