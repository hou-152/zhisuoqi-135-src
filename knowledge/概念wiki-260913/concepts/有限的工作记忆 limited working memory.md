...
模型的注意力像一张放不大的桌子。资料再多也只能摊开一部分，所以问题从「有没有资料」变成「这一刻该把哪几份摊在最上面」。

## 原文 context

随着 agent 兴起，「我们往这块有限的工作记忆里装载什么信息」变得更加重要。这是上下文工程之所以是「工程」的物理前提——空间有限，所以必须做取舍。

## 掌握证据（做到这些才算会）

- 能指出上下文空间有限是必须取舍的原因
- 能举出 agent 场景下工作记忆被装填的具体对象
