---
id: cm_4a3ac824
name: Model-relative Curriculum
type: CONCEPTUAL
...
高中生不该继续用小学教材。Agent 变强后，流程也要升级，否则能力增长会被过时规则锁住。

## 原文 context

模型能力升级像学生升学，原 skill 与 scaffold 需要重写；旧规则可能无法发挥新模型，甚至成为限制。

## 掌握证据（做到这些才算会）

- 能举出一条旧规则在新模型上反而拖后腿的例子
- 能说出升级后需要重写的 skill 或 scaffold 项
