...
- [[弱而模糊的评估器]] — 不懂【古德哈特定律】，就做不了【弱而模糊的评估器】的「识别指标被优化而非目标达成」
- [[有界改动与回归闸]] — 不懂古德哈特定律，就做不了有界改动与回归闸的「为什么必须限制 harness 编辑范围」

## 相关

- [[可维护性没有惩罚项]] · rejected（audit） — 古德哈特定律是普适原理，本项只是其一个实例，不构成前置依赖。
