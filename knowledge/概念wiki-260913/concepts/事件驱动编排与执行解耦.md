...
- [[确定性工程基础设施】 deterministic engineering infrastructure]] · **soft** — 持久重试、审计与可观测来自确定性基础设施提供的机制。

## 懂了它才能懂（解锁 2）

- [[普遍可触发 universally triggered]] — 触发与 agent loop 解耦，靠的正是外部事件驱动的编排层。
- [[小函数组合]] — 六个函数靠事件通信而非巨石调用，前提是编排与执行已解耦。
