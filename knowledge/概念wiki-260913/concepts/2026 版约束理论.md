...
> 承认模型有强弱约束，与其赌灯灭式跃迁，不如在约束内优化系统并读代码。
...
- [[局部最优 local optima]] · **soft** — 不懂局部最优，就做不了在约束内优化系统并接受不赌灯灭式跃迁这件事。

## 相关

- [[今天的魔法咒语，明天的反模式]] · related-to（audit） — 2026版约束理论可在约束内优化独立理解；今天的魔法咒语只是转向该理论的动机之一。
