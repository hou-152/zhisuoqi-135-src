...
**领域** verification-eval ｜ **类型** PROCEDURAL ｜ **什么时候学** 现在先懂 ｜ **怎么算会了** 能用 ｜ **中心度** 0.067
...
- [[Self-verification]] · **hard** — 回路是自检能力在写码-跑测-改错上的具体形态。
- [[Verifiable Codebase]] · **soft** — 闭环靠浏览器、测试等可验证工具支撑。
