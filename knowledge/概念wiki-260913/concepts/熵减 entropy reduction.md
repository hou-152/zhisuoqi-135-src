...
跟人说话可以省略一半，跟机器说话不能。省略掉的那一半，得有人补上——现在补的是你。机器越笨，你补得越多。

## 原文 context

论文对上下文工程本质的判断。人交流时听者会主动降低信息熵——用共有知识、情绪线索、情境感知补上没说的部分；机器目前缺这个能力，所以人必须替它预处理，把高熵的上下文和意图压缩成低熵表示。这份"effort"就是上下文工程的核心成本，且与机器智能水平成反比。
