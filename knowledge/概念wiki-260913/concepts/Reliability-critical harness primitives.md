...
**领域** harness-runtime ｜ **类型** META ｜ **什么时候学** 做到这里再懂 ｜ **怎么算会了** 能判 ｜ **中心度** 0.072
...
- [[primitives]] · related-to（audit） — 子项筛的是 harness 可靠性原语，与 SDK 的 Agents/Handoffs/Guardrails 不是同一概念，属术语串味，依赖不成立。
