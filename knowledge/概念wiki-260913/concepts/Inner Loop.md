...
像生产线本身，负责不断拿任务、加工、测试和修正，追求高效完成工作。

## 原文 context

Primary Agent 与用户、代码和工具交互，完成主要执行工作的循环，可在较少人工干预下长期运行。

## 掌握证据（做到这些才算会）

- 能指出该循环中 Agent 交互的三类对象
- 能说明该循环与人工干预频率之间的关系

## 验收问句

> {{name}} 里 Primary Agent 在和谁、和什么交互？

## 先懂这些（前置 1）

- [[Agent loop]] · **soft** — Inner Loop 就是主 agent 的执行循环，即 agent loop 的另一种叫法。

## 懂了它才能懂（解锁 1）

- [[Outer Loop]] — 外循环负责监督内循环，没有内循环就无所谓外循环。
