...
depth: 0
origin: [notion]
aliases: ["Sensors and Actuators", "sensors", "actuators", "传感器与执行器"]
sources: 1
---

# Sensors 与 Actuators

> Agent-native 的两个原语：感知器把世界状态数字化，执行器让 Agent 改变世界。
...
- 能把 API、CLI、日志、权限系统归入 sensor 或 actuator
- 能说明基础设施为何被重构为这两类
...
- Notion 概念库 ｜ Notion 概念库 ｜ https://app.notion.com/p/Sensors-Actuators-079679b108ff836d8b610153474f342b

## 别名

`Sensors and Actuators`、`sensors`、`actuators`、`传感器与执行器`
