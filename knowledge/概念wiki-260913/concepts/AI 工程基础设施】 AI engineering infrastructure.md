...
id: cm_bfabbb33
name: AI 工程基础设施】
nameEn: AI engineering infrastructure
type: CONCEPTUAL
...
depth: 0
origin: [harness]
aliases: ["AI engineering infrastructure"]
sources: 1
---

# AI 工程基础设施】 · AI engineering infrastructure

> 指出做 Agent 已不是写提示词，而需要一整套工程基础设施的判断。

**领域** harness-runtime ｜ **类型** CONCEPTUAL ｜ **什么时候学** 做到这里再懂 ｜ **怎么算会了** 能判 ｜ **中心度** 0.072

## 费曼一下

让 AI 在生产环境真正能用的那套外围工程系统——不是模型本身，而是围绕模型搭起来的项目记忆、工作流、护栏、文档、工具组成的"基建"。范式从"调 prompt"切换到"造基建"。
...
- [[三层工程 prompt context harness engineering]] — prompt/context/harness 的划分，是对『需要整套工程基础设施』的展开。
- [[为 AI 设计工作环境]] — 工程师能力转向设计环境，正因为有一整套工程基础设施要做。
