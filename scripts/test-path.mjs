...
check('没装配的概念仍然照实说没装配（不借别的材料冒充完成）', await ex(`(()=>{openPanel('cm_a4f9a7e3'); const t=document.getElementById('pbody').innerText; return t.includes('尚未装配')&&t.includes('不计入当前路线进度')})()`), 'true');
